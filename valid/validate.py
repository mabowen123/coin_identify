...
parser.add_argument(
    ...
    metavar="NAME",
    default="valida",
    help="dataset split (default: valida)",
)
parser.add_argument(
    "--dataset-download",
    action="store_true",
...
def validate(args):
    ...
    # print(root_dir, args.dataset, args.split)
    ...
    print("res", args.batch_size, args.prefetcher, args.tf_preprocessing)
    ...
    with torch.no_grad():
        ...
        for batch_idx, (input, target) in enumerate(loader):
            ...
            # print(output.topk(1, 1, True, True).indices, target)
...
def main():
    ...
    if os.path.isdir(args.checkpoint):
        ...
        # checkpoints = glob.glob(args.checkpoint + '/*best.pth.tar')
