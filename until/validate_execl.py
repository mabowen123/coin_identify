...
train = "/Users/mabowen/Downloads/4.19元祐通宝训练样本1.xlsx"
vaild = "/Users/mabowen/Downloads/4.19元祐通宝测试样本1.xlsx"
# 对比a、b两个文件的正面图片是否有重复
...
# 保存去重后的数据
# dfB = dfB[~dfB['正面图片'].isin(dfA['正面图片'])]
# dfB.to_excel(train, index=False)
print("\n")
