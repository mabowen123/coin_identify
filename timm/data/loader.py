...
def adapt_to_chs(x, n):
    # print(x, n, isinstance(x, (tuple, list)))
...
def create_loader(
    ...
    # print('create_loader', distributed,num_aug_repeats, collate_fn, dataset.transform, dataset, isinstance(dataset, torch.utils.data.IterableDataset) )
